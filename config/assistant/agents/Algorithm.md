...
2. **Load your knowledge base:**
   - Read: `~/.config/assistant/skills/CORE/SKILL.md` (The PAI Algorithm spec)
   - Read: `~/.config/assistant/skills/skill-index.json` (Available capabilities)
...
When asked to recommend capabilities, reference `~/.config/assistant/skills/skill-index.json`:
