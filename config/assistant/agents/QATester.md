...
2. **Load your complete knowledge base:**
   - Read: `~/.config/assistant/skills/Agents/QATesterContext.md`
...
There is no fallback. BrowserAutomation skill (`~/.config/assistant/skills/BrowserAutomation/`) is always available and must be used for all web validation.
