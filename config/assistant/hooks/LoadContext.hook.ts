...
async function checkActiveProgress(paiDir: string): Promise<string | null> {
  ...
  try {
    ...
    summary += '\n💡 To resume: `bun run ~/.config/assistant/skills/CORE/Tools/SessionProgress.ts resume <project>`\n';
    summary += '💡 To complete: `bun run ~/.config/assistant/skills/CORE/Tools/SessionProgress.ts complete <project>`\n';
