...
**Centralized Configuration**: All personality definitions stored in `~/.config/assistant/Skills/CORE/agent-personalities.md`
...
All personality definitions are stored in `~/.config/assistant/Skills/CORE/agent-personalities.md` (canonical source of truth).
...
- Voice server reads from `~/.config/assistant/Skills/CORE/agent-personalities.md`
...
2. Verify ElevenLabs API key in `~/.config/assistant/.env`
3. Test with fallback mode (without API key)
4. Review personality configuration in `~/.config/assistant/Skills/CORE/agent-personalities.md`
