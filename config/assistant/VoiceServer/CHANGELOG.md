...
- **Pronunciation Customization**: User-configurable pronunciation substitutions
  - Loads from `~/.config/assistant/skills/CORE/USER/pronunciations.json`
...
- **BREAKING: Centralized Configuration Architecture**
  - Agent personalities now defined in `~/.config/assistant/Skills/CORE/agent-personalities.md`
...
### Architecture
- Single source of truth: `~/.config/assistant/Skills/CORE/agent-personalities.md`
...
- Environment-based configuration via `~/.config/assistant/.env`
