...
**Location:** `~/.config/assistant/skills/Webassessment/osint-tools/dnsrecon/`
...
**How to Run:**
```bash
cd ~/.config/assistant/skills/Webassessment/osint-tools/dnsrecon
...
**Location:** `~/.config/assistant/skills/Webassessment/osint-tools/whatweb/`
...
**How to Run:**
```bash
cd ~/.config/assistant/skills/Webassessment/osint-tools/whatweb
