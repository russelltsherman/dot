...
cd ~/.config/assistant/skills/Webassessment/osint-tools
...
**Location:** `~/.config/assistant/skills/Webassessment/osint-tools/sherlock/`
...
**Location:** `~/.config/assistant/skills/Webassessment/osint-tools/Osintgram/`
...
**Location:** `~/.config/assistant/skills/Webassessment/osint-tools/tinfoleak/`
...
mkdir -p ~/.config/assistant/skills/Webassessment/osint-tools/
...
- Command: `source ~/.config/assistant/skills/Webassessment/osint-tools/osint-venv/bin/activate`
