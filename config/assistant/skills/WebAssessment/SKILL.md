...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/WebAssessment/`
...
bun ~/.config/assistant/skills/Recon/Tools/CorporateStructure.ts target.com

# Subdomain enumeration
bun ~/.config/assistant/skills/Recon/Tools/SubdomainEnum.ts target.com

# Endpoint discovery from JavaScript
bun ~/.config/assistant/skills/Recon/Tools/EndpointDiscovery.ts https://target.com

# Port scanning
bun ~/.config/assistant/skills/Recon/Tools/PortScan.ts target.com

# Path discovery
bun ~/.config/assistant/skills/Recon/Tools/PathDiscovery.ts https://target.com
```
