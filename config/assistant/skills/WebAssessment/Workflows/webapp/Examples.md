...
## Examples Location
`~/.config/assistant/skills/Webassessment/webapp-examples/`
...
```bash
python ~/.config/assistant/skills/Webassessment/webapp-scripts/with_server.py \
    --server "npm run dev" \
    --port 5173 \
    -- python my_test.py
```
...
- Web app testing guide: `~/.config/assistant/skills/Webassessment/Workflows/webapp/testing-guide.md`
- Server helper script: `~/.config/assistant/skills/Webassessment/webapp-scripts/with_server.py`
