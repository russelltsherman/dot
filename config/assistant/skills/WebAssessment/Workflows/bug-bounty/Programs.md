...
cd ~/.config/assistant/skills/Webassessment/bug-bounty-tool
...
- See: `~/.config/assistant/skills/Webassessment/Workflows/pentest/master-methodology.md`
...
### Tool Location
`~/.config/assistant/skills/Webassessment/bug-bounty-tool/`
...
### Usage
See: `~/.config/assistant/skills/Webassessment/Workflows/bug-bounty/automation-tool.md`
...
- Automation tool docs: `~/.config/assistant/skills/Webassessment/Workflows/bug-bounty/AutomationTool.md`
- Pentest methodology: `~/.config/assistant/skills/Webassessment/Workflows/pentest/MasterMethodology.md`
- Reconnaissance workflow: `~/.config/assistant/skills/Webassessment/Workflows/pentest/Reconnaissance.md`
- Exploitation workflow: `~/.config/assistant/skills/Webassessment/Workflows/pentest/Exploitation.md`
