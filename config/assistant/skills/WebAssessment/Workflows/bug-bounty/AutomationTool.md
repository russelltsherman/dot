...
- Bug bounty programs guide: `~/.config/assistant/skills/Webassessment/Workflows/bug-bounty/Programs.md`
...
- Full tool documentation: `~/.config/assistant/skills/Webassessment/bug-bounty-tool/README.md`
