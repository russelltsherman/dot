...
## Location
`~/.config/assistant/skills/Webassessment/ffuf-helper.py`
...
### Wordlists
The helper uses wordlists from `~/.config/assistant/skills/Webassessment/ffuf-resources/`:
...
- Main FFUF guide: `~/.config/assistant/skills/Webassessment/Workflows/ffuf/ffuf-guide.md`
- Pentest methodology: `~/.config/assistant/skills/Webassessment/Workflows/pentest/master-methodology.md`
- Wordlist resources: `~/.config/assistant/skills/Webassessment/ffuf-resources/`
