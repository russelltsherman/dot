...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/OSINT/`
...
```
~/.config/assistant/MEMORY/WORK/$(jq -r '.work_dir' ~/.config/assistant/MEMORY/STATE/current-work.json)/scratch/YYYY-MM-DD-HHMMSS_osint-[target]/
```

**Archived reports:**
```
~/.config/assistant/History/research/YYYY-MM/[target]-osint/
```
