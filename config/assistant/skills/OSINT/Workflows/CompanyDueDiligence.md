...
```
~/.config/assistant/MEMORY/WORK/$(jq -r '.work_dir' ~/.config/assistant/MEMORY/STATE/current-work.json)/scratch/YYYY-MM-DD-HHMMSS_due-diligence-[company]/
  phase1-domains.md
  phase2-technical.md
  phase3-research.md
  phase4-vetting.md
...
~/.config/assistant/History/research/YYYY-MM/[company]-due-diligence/
