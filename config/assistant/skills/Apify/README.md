...
```typescript
import { Apify } from '~/.config/assistant/filesystem-mcps/apify'
...
```typescript
import { Actor, ActorRun, DatasetOptions } from '~/.config/assistant/filesystem-mcps/apify'
```
...
cd ~/.config/assistant/filesystem-mcps/apify
...
- Parent README: `~/.config/assistant/filesystem-mcps/README.md`
