...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Apify/`
...
**Architecture:** See `~/.config/assistant/skills/CORE/SYSTEM/DOCUMENTATION/FileBasedMCPs.md`
...
```typescript
import { scrapeInstagramProfile, searchGoogleMaps } from '~/.config/assistant/skills/Apify/actors'
...
```typescript
import { scrapeInstagramProfile, scrapeInstagramPosts } from '~/.config/assistant/skills/Apify/actors'
...
**LinkedIn - Job search:**
```typescript
import { searchLinkedInJobs } from '~/.config/assistant/skills/Apify/actors'
...
```typescript
import { scrapeTikTokHashtag } from '~/.config/assistant/skills/Apify/actors'
...
```typescript
import { searchGoogleMaps } from '~/.config/assistant/skills/Apify/actors'
...
```typescript
import { scrapeGoogleMapsReviews } from '~/.config/assistant/skills/Apify/actors'
...
```typescript
import { scrapeAmazonProduct } from '~/.config/assistant/skills/Apify/actors'
...
```typescript
import { scrapeWebsite } from '~/.config/assistant/skills/Apify/actors'
...
import {
  ...
  scrapeTikTokHashtag,
  searchYouTube
} from '~/.config/assistant/skills/Apify/actors'
...
```typescript
import { searchGoogleMaps, scrapeLinkedInProfile } from '~/.config/assistant/skills/Apify/actors'
