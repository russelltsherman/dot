...
**Location:** `~/.config/assistant/skills/social/SKILL.md`
...
2. System runs: `bun ~/.config/assistant/filesystem-mcps/apify/get-latest-tweet.ts`
...
bun ~/.config/assistant/filesystem-mcps/apify/get-user-tweets.ts ThePrimeagen 10

# Analyze Paul Graham's recent thoughts
bun ~/.config/assistant/filesystem-mcps/apify/get-user-tweets.ts paulg 20

# Track Simon Willison's posts
bun ~/.config/assistant/filesystem-mcps/apify/get-user-tweets.ts simonw 15
```
...
bun ~/.config/assistant/filesystem-mcps/apify/get-latest-thread.ts
...
bun ~/.config/assistant/filesystem-mcps/apify/get-latest-tweet.ts
...
✅ Run from `~/.config/assistant/filesystem-mcps/apify/` directory or use full path
...
**For Users:**
- Quick reference: `~/.config/assistant/filesystem-mcps/SCRIPTS-REFERENCE.md`
- Social skill: `~/.config/assistant/skills/social/SKILL.md`

**For Developers:**
- Implementation: `~/.config/assistant/filesystem-mcps/apify/README.md`
- Standards: `~/.config/assistant/filesystem-mcps/STANDARDS.md`
- Parent guide: `~/.config/assistant/filesystem-mcps/README.md`
