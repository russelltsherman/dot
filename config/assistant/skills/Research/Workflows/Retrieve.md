...
**Working Directory (Scratch):** `~/.config/assistant/MEMORY/WORK/{current_work}/scratch/`
...
2. **History (Permanent Archive):**
   - Move to `~/.config/assistant/History/research/YYYY-MM-DD_[description]/` when complete
...
```
~/.config/assistant/MEMORY/WORK/20260111-172408_retrieve-react19-docs/scratch/
├── raw-content/
...
```
~/.config/assistant/History/research/2025-10-26_react19-documentation/
