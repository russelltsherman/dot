...
- **Source:** `~/.config/assistant/commands/perform-claude-research.md`
- **Destination:** `~/.config/assistant/skills/Research/Workflows/ClaudeResearch.md`
- **Size:** 3.6K
...
- **Source:** `~/.config/assistant/commands/perform-perplexity-research.md`
- **Destination:** `~/.config/assistant/skills/Research/Workflows/PerplexityResearch.md`
- **Size:** 8.1K
...
- **Source:** `~/.config/assistant/commands/perform-interview-research.md`
- **Destination:** `~/.config/assistant/skills/Research/Workflows/InterviewResearch.md`
- **Size:** 4.4K
...
- **Source:** `~/.config/assistant/commands/analyze-ai-trends.md`
- **Destination:** `~/.config/assistant/skills/Research/Workflows/AnalyzeAiTrends.md`
- **Size:** 3.0K
...
**Location:** `~/.config/assistant/skills/Research/Workflows/`
...
The original command files remain in `~/.config/assistant/commands/`:
