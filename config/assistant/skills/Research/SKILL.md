...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Research/`
...
**Scratch (temporary work artifacts):** `~/.config/assistant/MEMORY/WORK/{current_work}/scratch/`
- Read `~/.config/assistant/MEMORY/STATE/current-work.json` to get the `work_dir` value
...
**History (permanent):** `~/.config/assistant/History/research/YYYY-MM/YYYY-MM-DD_[topic]/`
