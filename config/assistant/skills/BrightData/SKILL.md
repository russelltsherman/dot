...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/BrightData/`
...
→ **READ:** ~/.config/assistant/skills/brightdata/Workflows/Four-tier-scrape.md
...
- `~/.config/assistant/skills/CORE/SkillSystem.md` - Canonical structure guide
- `~/.config/assistant/skills/CORE/CONSTITUTION.md` - Overall PAI philosophy
