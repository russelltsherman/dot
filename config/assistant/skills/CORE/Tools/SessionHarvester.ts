 ...
 *
 * Harvests insights from ~/.config/assistant/projects/ sessions and writes to LEARNING/
 *
 * Commands:
...
const PROJECTS_DIR = path.join(PAI_CONFIG_DIR, "projects", `-Users-${USERNAME}--claude`);
const LEARNING_DIR = path.join(PAI_CONFIG_DIR, "MEMORY", "LEARNING");
