...
const CREATE_UPDATE_SCRIPT = join(PAI_DIR, 'skills/System/Tools/CreateUpdate.ts');
  ...
  if (aiNarrative) {
    return {
      narrative: {
        ...
        verification_commands: [`bun ~/.config/assistant/skills/System/Tools/UpdateSearch.ts recent 5`],
        confidence: 'high',
      },
