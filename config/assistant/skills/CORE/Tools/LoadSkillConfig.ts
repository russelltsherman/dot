 ...
 *
 * Usage:
 *   import { loadSkillConfig } from '~/.config/assistant/skills/CORE/Tools/LoadSkillConfig';
 *   const config = loadSkillConfig<MyConfigType>(__dirname, 'config.json');
 *
 * Or CLI:
 *   bun ~/.config/assistant/skills/CORE/Tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
...
Examples:
  bun LoadSkillConfig.ts ~/.config/assistant/skills/PAIUpgrade sources.json
