 ...
 *
 * Usage:
 *   bun ~/.config/assistant/skills/CORE/Tools/SecretScan.ts <directory>
 *   bun ~/.config/assistant/skills/CORE/Tools/SecretScan.ts . --verbose
 *   bun ~/.config/assistant/skills/CORE/Tools/SecretScan.ts . --verify
 *
 * @see ~/.config/assistant/skills/System/Workflows/SecretScanning.md
 */
