 ...
 *
 * Usage:
 *   bun run ~/.config/assistant/skills/CORE/Tools/SkillSearch.ts <query>
 *   bun run ~/.config/assistant/skills/CORE/Tools/SkillSearch.ts "scrape instagram"
 *   bun run ~/.config/assistant/skills/CORE/Tools/SkillSearch.ts --list           # List all skills
 *   bun run ~/.config/assistant/skills/CORE/Tools/SkillSearch.ts --tier always    # List always-loaded skills
 *   bun run ~/.config/assistant/skills/CORE/Tools/SkillSearch.ts --tier deferred  # List deferred skills
 *
...
async function main() {
  ...
  if (!existsSync(INDEX_FILE)) {
    ...
    console.error('   bun run ~/.config/assistant/skills/CORE/Tools/GenerateSkillIndex.ts');
    process.exit(1);
  }
