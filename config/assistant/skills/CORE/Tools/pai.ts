...
const MCP_DIR = join(PAI_CONFIG_DIR, "MCPs");
const ACTIVE_MCP = join(PAI_CONFIG_DIR, ".mcp.json");
const BANNER_SCRIPT = join(PAI_CONFIG_DIR, "skills", "CORE", "Tools", "Banner.ts");
