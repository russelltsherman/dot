...
function countSkills(): number {
  const skillsDir = join(PAI_CONFIG_DIR, "skills");
...
function countHooks(): number {
  const hooksDir = join(PAI_CONFIG_DIR, "hooks");
...
function countWorkItems(): string {
  const workDir = join(PAI_CONFIG_DIR, "MEMORY", "WORK");
...
function countLearnings(): number {
  const learningsDir = join(PAI_CONFIG_DIR, "MEMORY", "LEARNING");
...
function countUserFiles(): number {
  const userDir = join(PAI_CONFIG_DIR, "skills/CORE/USER");
