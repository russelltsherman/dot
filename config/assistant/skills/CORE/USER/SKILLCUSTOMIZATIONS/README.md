...
```bash
mkdir -p ~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/SkillName
```
...
```bash
mkdir -p ~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Art
```
...
See: `~/.config/assistant/skills/CORE/SYSTEM/SKILLSYSTEM.md` (Skill Customization System section)
