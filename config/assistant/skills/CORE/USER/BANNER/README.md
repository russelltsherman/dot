...
```
~/.config/assistant/skills/CORE/Tools/Banner.ts
```
...
bun ~/.config/assistant/skills/CORE/Tools/Banner.ts

# Display specific design
bun ~/.config/assistant/skills/CORE/Tools/Banner.ts --design=electric

# Preview all designs
bun ~/.config/assistant/skills/CORE/Tools/Banner.ts --test
```
...
The banner reads configuration from `~/.config/assistant/settings.json`:
