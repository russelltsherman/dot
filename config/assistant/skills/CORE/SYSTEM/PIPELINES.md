...
Every pipeline lives in `~/.config/assistant/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md`
...
**Action:** `~/.config/assistant/ACTIONS/[Action_Name]/ACTION.md`
...
```bash
mkdir -p ~/.config/assistant/PIPELINES/[Domain]_[Pipeline-Name]
cp ~/.config/assistant/PIPELINES/PIPELINE-TEMPLATE.md ~/.config/assistant/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md
```
...
- **Actions:** `~/.config/assistant/skills/CORE/SYSTEM/ACTIONS.md`
- **Architecture:** `~/.config/assistant/skills/CORE/SYSTEM/PAISYSTEMARCHITECTURE.md`
- **Template:** `~/.config/assistant/PIPELINES/PIPELINE-TEMPLATE.md`
- **Example:** `~/.config/assistant/PIPELINES/Blog_Publish-Post/PIPELINE.md`
