...
HIGH TRUST:    PAI skill files and agent configs
               ↓
MEDIUM TRUST:  Verified code in ~/.config/assistant/
               ↓
...
**Security events are logged as individual files:** `~/.config/assistant/MEMORY/SECURITY/YYYY/MM/security-{summary}-{timestamp}.jsonl`
