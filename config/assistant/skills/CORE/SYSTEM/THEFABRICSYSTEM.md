...
**Primary Skill:** `~/.config/assistant/skills/Fabric/SKILL.md`
...
**Patterns Location:** `~/.config/assistant/skills/Fabric/Patterns/` (237 patterns)
...
-> Runs fabric -U
-> Syncs to ~/.config/assistant/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ ~/.config/assistant/skills/Fabric/Patterns/
```
...
- **Full Skill:** `~/.config/assistant/skills/Fabric/SKILL.md`
- **Pattern Execution:** `~/.config/assistant/skills/Fabric/Workflows/ExecutePattern.md`
- **All Patterns:** `~/.config/assistant/skills/Fabric/Patterns/`
