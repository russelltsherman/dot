...
**All documentation files are in `~/.config/assistant/skills/CORE/` with SYSTEM/ and USER/ subdirectories. Read these files when you need deeper context.**
...
**Agent System:**
- **Agents Skill** (`~/.config/assistant/skills/Agents/`) - Complete agent composition system | See Agents skill for custom agent creation, traits, and voice mappings
