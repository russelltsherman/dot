...
- Reference `~/.config/assistant/skills/CORE/USER/` for any personalization
...
```bash
ls -1 ~/.config/assistant/skills/ | grep "^_"
```
...
- `~/.config/assistant/skills/CORE/USER/CONTACTS.md` - Contact information
- `~/.config/assistant/skills/CORE/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p ~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/SkillName`
...
**See:** `~/.config/assistant/skills/Science/Protocol.md` for the full protocol interface
...
**Full documentation:** `~/.config/assistant/skills/CORE/SYSTEM/THENOTIFICATIONSYSTEM.md`
...
Read ~/.config/assistant/skills/Art/Aesthetic.md
```
...
```
~/.config/assistant/skills/Createskill/Workflows/CanonicalizeSkill.md
```
...
5. Move backups to `~/.config/assistant/MEMORY/Backups/`
...
**Reference:** `~/.config/assistant/skills/_BLOGGING/SKILL.md`
...
**See:** `~/.config/assistant/skills/CORE/SYSTEM/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `~/.config/assistant/skills/CORE/SYSTEM/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation
 ...
 *
 * Usage:
 *   bun ~/.config/assistant/skills/SkillName/Tools/ToolName.ts <command> [options]
 *
 * Commands:
