...
**Location:** `~/.config/assistant/skills/CORE/Tools/Inference.ts`
...
bun ~/.config/assistant/skills/CORE/Tools/Inference.ts --level fast "System prompt" "User prompt"

# Standard (Sonnet) - balanced reasoning, typical analysis
bun ~/.config/assistant/skills/CORE/Tools/Inference.ts --level standard "System prompt" "User prompt"

# Smart (Opus) - deep reasoning, strategic decisions
bun ~/.config/assistant/skills/CORE/Tools/Inference.ts --level smart "System prompt" "User prompt"

# With JSON output
bun ~/.config/assistant/skills/CORE/Tools/Inference.ts --json --level fast "Return JSON" "Input"

# Custom timeout
bun ~/.config/assistant/skills/CORE/Tools/Inference.ts --level standard --timeout 60000 "Prompt" "Input"
```
...
**Location:** `~/.config/assistant/skills/CORE/Tools/RemoveBg.ts`
...
bun ~/.config/assistant/skills/CORE/Tools/RemoveBg.ts /path/to/image.png

# Remove background and save to different path
bun ~/.config/assistant/skills/CORE/Tools/RemoveBg.ts /path/to/input.png /path/to/output.png

# Process multiple images
bun ~/.config/assistant/skills/CORE/Tools/RemoveBg.ts image1.png image2.png image3.png
```
...
**Location:** `~/.config/assistant/skills/CORE/Tools/AddBg.ts`
...
bun ~/.config/assistant/skills/CORE/Tools/AddBg.ts /path/to/transparent.png "#EAE9DF" /path/to/output.png

# Add UL brand background color
bun ~/.config/assistant/skills/CORE/Tools/AddBg.ts /path/to/transparent.png --ul-brand /path/to/output.png
```
...
**Location:** `~/.config/assistant/skills/CORE/Tools/GetTranscript.ts`
...
bun ~/.config/assistant/skills/CORE/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID"

# Save transcript to file
bun ~/.config/assistant/skills/CORE/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID" --save /path/to/transcript.txt
```
...
**Technical Details:**
- Voice server must be running (`~/.config/assistant/skills/VoiceServer/`)
...
**Location:** `~/.config/assistant/skills/CORE/Tools/extract-transcript.py`
...
cd ~/.config/assistant/skills/CORE/Tools/
...
**Location:** `~/.config/assistant/skills/CORE/Tools/YouTubeApi.ts`
...
bun ~/.config/assistant/skills/CORE/Tools/YouTubeApi.ts --channel-stats

# Get video statistics
bun ~/.config/assistant/skills/CORE/Tools/YouTubeApi.ts --video-stats VIDEO_ID

# Get latest uploads
bun ~/.config/assistant/skills/CORE/Tools/YouTubeApi.ts --latest-videos
```
...
1. **Add tool file:** Place `.ts` or `.py` file directly in `~/.config/assistant/skills/CORE/Tools/`
...
2. **Document here:** Add section to this file with:
   - Tool location (e.g., `~/.config/assistant/skills/CORE/Tools/ToolName.ts`)
   - Usage examples
...
See `~/.config/assistant/skills/Deprecated/` for archived skill files.
