...
### Report Locations
- **Iterative Work:** `~/.config/assistant/MEMORY/WORK/{current_work}/scratch/` (tied to work item for learning)
- **Formal Assessments:** `~/.config/assistant/MEMORY/RESEARCH/YYYY-MM/`
