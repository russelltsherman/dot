...
SCAN_FILE=~/.config/assistant/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d)_nmap-scan.txt

# Or masscan results
MASSCAN_FILE=~/.config/assistant/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d)_masscan.json

# Or combined multi-tool archive from history
SCAN_DIR=~/.config/assistant/History/security/scans/2025-11-target-recon/
```
...
// Usage: bun run tools/batch-scan-analysis.ts ~/.config/assistant/MEMORY/WORK/{current_work}/scratch/target-scans/
```
