...
```bash
bun run ~/.config/assistant/skills/Agents/Tools/AgentFactory.ts --list
```
...
- Full trait definitions: `~/.config/assistant/skills/Agents/Data/Traits.yaml`
- Voice mappings: Lines 349-794 in Traits.yaml
- AgentFactory tool: `~/.config/assistant/skills/Agents/Tools/AgentFactory.ts`
