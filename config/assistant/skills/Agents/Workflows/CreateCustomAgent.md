...
bun run ~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts \
...
- ComposeAgent tool: `~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts`
- Voice mappings: `~/.config/assistant/skills/Agents/AgentPersonalities.md`
