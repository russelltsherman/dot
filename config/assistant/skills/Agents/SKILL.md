...
```
~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Agents/
...
```bash
# Usage examples
bun run ~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts --task "Review security"
bun run ~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"
bun run ~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts --list
bun run ~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts --output json
```
