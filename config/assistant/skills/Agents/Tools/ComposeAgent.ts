 ...
 *
 * Configuration files:
 *   Base:  ~/.config/assistant/skills/Agents/Data/Traits.yaml
 *   User:  ~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
 *
 * Usage:
...
CONFIGURATION:
  Base traits:  ~/.config/assistant/skills/Agents/Data/Traits.yaml
  User traits:  ~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
