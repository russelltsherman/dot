...
```
~/.config/assistant/skills/Agents/
...
Old YAML system backed up to: `~/.config/assistant/History/Backups/2025-12-18-AgentProfiles/`
...
bun run ~/.config/assistant/skills/Agents/Tools/LoadAgentContext.ts
# Output: Architect, Artist, Engineer, Designer, QATester

# View specific context
bun run ~/.config/assistant/skills/Agents/Tools/LoadAgentContext.ts Architect

# Generate enriched prompt
bun run ~/.config/assistant/skills/Agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
