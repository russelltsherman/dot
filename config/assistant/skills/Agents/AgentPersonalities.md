...
**What happens:**
1. Run `bun run ~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts` for EACH agent
...
- Trait definitions: `~/.config/assistant/skills/Agents/Data/Traits.yaml`
- Agent template: `~/.config/assistant/skills/Agents/Templates/DynamicAgent.hbs`
- Composition tool: `~/.config/assistant/skills/Agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: `~/.config/assistant/skills/CORE/AgentPersonalities.md` (this file)
- **Consumer**: `~/.config/assistant/VoiceServer/server.ts` extracts JSON config from this file
