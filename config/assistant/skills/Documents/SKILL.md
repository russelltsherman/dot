...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Documents/`
...
`read ~/.config/assistant/skills/CORE/SKILL.md`
...
- Scripts: `~/.config/assistant/skills/documents/docx/Scripts/`
- OOXML tools: `~/.config/assistant/skills/documents/docx/ooxml/`
- License: `~/.config/assistant/skills/documents/docx/LICENSE.txt`
...
**Supporting Resources:**
- Scripts: `~/.config/assistant/skills/documents/pdf/Scripts/`
- License: `~/.config/assistant/skills/documents/pdf/LICENSE.txt`
...
**Supporting Resources:**
- Scripts: `~/.config/assistant/skills/documents/pptx/Scripts/`
- OOXML tools: `~/.config/assistant/skills/documents/pptx/ooxml/`
- License: `~/.config/assistant/skills/documents/pptx/LICENSE.txt`
...
**Supporting Resources:**
- Recalc script: `~/.config/assistant/skills/documents/xlsx/recalc.py`
- License: `~/.config/assistant/skills/documents/xlsx/LICENSE.txt`
...
**Word Documents (DOCX):**
- Main Guide: `~/.config/assistant/skills/documents/docx/SKILL.md`
- Creation Reference: `~/.config/assistant/skills/documents/docx/docx-js.md`
- Editing Reference: `~/.config/assistant/skills/documents/docx/ooxml.md`

**PDF Processing:**
- Main Guide: `~/.config/assistant/skills/documents/pdf/SKILL.md`
- Forms Guide: `~/.config/assistant/skills/documents/pdf/forms.md`
- Advanced Reference: `~/.config/assistant/skills/documents/pdf/reference.md`

**PowerPoint Presentations (PPTX):**
- Main Guide: `~/.config/assistant/skills/documents/pptx/SKILL.md`
- Creation Reference: `~/.config/assistant/skills/documents/pptx/html2pptx.md`
- Editing Reference: `~/.config/assistant/skills/documents/pptx/ooxml.md`

**Excel Spreadsheets (XLSX):**
- Main Guide: `~/.config/assistant/skills/documents/xlsx/SKILL.md`
- Recalc Script: `~/.config/assistant/skills/documents/xlsx/recalc.py`
