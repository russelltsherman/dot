...
import { insertNewsletterContent } from '~/.config/assistant/skills/parser/db';
...
- For traditional PDF extraction (text-only), see `~/.config/assistant/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `~/.config/assistant/skills/documents/pdf/forms.md`
- For parser integration, see `~/.config/assistant/skills/parser/SKILL.md`
- For newsletter database schema, see `~/.config/assistant/Context/databases/newsletter/schema.sql`
