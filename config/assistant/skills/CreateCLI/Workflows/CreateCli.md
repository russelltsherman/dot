...
**Reference:** `~/.config/assistant/skills/CORE/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see ~/.config/assistant/Bin/{{CLI_NAME}}/README.md
...
See: ~/.config/assistant/Bin/{{CLI_NAME}}/README.md
```
...
**Validation Commands:**
```bash
cd ~/.config/assistant/Bin/{{CLI_NAME}}/
chmod +x {{CLI_NAME}}.ts
./{{CLI_NAME}}.ts --help
./{{CLI_NAME}}.ts --version
```
...
**Report to user:**
```
✅ CLI Created: ~/.config/assistant/Bin/{{CLI_NAME}}/
...
Documentation: ~/.config/assistant/Bin/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
✅ CLI Created: ~/.config/assistant/Bin/notioncli/
...
3. Read: ~/.config/assistant/Bin/notioncli/README.md
...
Use proven structure from ~/.config/assistant/Bin/llcli/ as reference.
