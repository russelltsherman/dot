...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`
...
Read and analyze:
- ~/.config/assistant/MEMORY/STATE/current-work.json
...
Analyze:
- ~/.config/assistant/skills/ (installed skills)
- ~/.config/assistant/hooks/ (active hooks)
- ~/.config/assistant/settings.json (configuration)
...
**User Customizations** (`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`):
