...
- ~/.config/assistant/skills/CORE/USER/TELOS/TELOS.md
- ~/.config/assistant/skills/CORE/USER/TELOS/GOALS.md
- ~/.config/assistant/skills/CORE/USER/TELOS/PROJECTS.md
- ~/.config/assistant/skills/CORE/USER/TELOS/CHALLENGES.md
- ~/.config/assistant/skills/CORE/USER/TELOS/STATUS.md
...
- Read ~/.config/assistant/MEMORY/STATE/current-work.json
...
- List skills in ~/.config/assistant/skills/
- List hooks in ~/.config/assistant/hooks/
- Read ~/.config/assistant/settings.json
...
Run: bun ~/.config/assistant/skills/PAIUpgrade/Tools/Anthropic.ts
...
1. Load channel config:
   bun ~/.config/assistant/skills/CORE/Tools/LoadSkillConfig.ts ~/.config/assistant/skills/PAIUpgrade youtube-channels.json
...
3. Compare against state:
   cat ~/.config/assistant/skills/PAIUpgrade/State/youtube-videos.json

4. For NEW videos, extract transcripts:
   bun ~/.config/assistant/skills/CORE/Tools/GetTranscript.ts '<video-url>'
...
1. Look in ~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/
