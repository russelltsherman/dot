...
**Prerequisites:**
- Aphorism database exists at `~/.config/assistant/skills/aphorisms/Database/aphorisms.md`
...
**Read database:**
```bash
Read ~/.config/assistant/skills/aphorisms/Database/aphorisms.md
```
...
Edit(
  file_path=~/.config/assistant/skills/aphorisms/Database/aphorisms.md,
