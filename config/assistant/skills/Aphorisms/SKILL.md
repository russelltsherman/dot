...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Aphorisms/`
...
→ **READ:** ~/.config/assistant/skills/aphorisms/Workflows/Find-aphorism.md
...
→ **READ:** ~/.config/assistant/skills/aphorisms/Workflows/Add-aphorism.md
...
→ **READ:** ~/.config/assistant/skills/aphorisms/Workflows/Research-thinker.md
...
→ **READ:** ~/.config/assistant/skills/aphorisms/Workflows/Search-aphorisms.md
...
**Location:** `~/.config/assistant/skills/aphorisms/Database/aphorisms.md`
...
**Database Location:**
`~/.config/assistant/skills/aphorisms/Database/aphorisms.md`
