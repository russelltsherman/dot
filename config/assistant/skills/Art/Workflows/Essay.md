...
```bash
Read ~/.config/assistant/skills/Art/SKILL.md
```
...
bun run ~/.config/assistant/skills/art/Tools/Generate.ts \
...
bun ~/.config/assistant/skills/CORE/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun ~/.config/assistant/skills/CORE/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `~/.config/assistant/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in ~/.config/assistant/skills/CORE/aesthetic.md
