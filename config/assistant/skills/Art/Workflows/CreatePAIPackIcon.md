...
- `~/.config/assistant/skills/_PAI/Workflows/CreatePack.md` - Uses this for icon generation
- `~/.config/assistant/skills/_PAI/Workflows/ValidatePack.md` - Validates icon exists
- `~/.config/assistant/skills/_PAI/Workflows/PAIIntegrityCheck.md` - Checks all icons
