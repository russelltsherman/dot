...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Art/`
...
**Load from:** `~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
