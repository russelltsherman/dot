...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/Fabric/`
...
**Patterns Location:** `~/.config/assistant/skills/Fabric/Patterns/`
...
| Path | Purpose |
|------|---------|
| `~/.config/assistant/skills/Fabric/Patterns/` | Local pattern storage (240+) |
| `~/.config/assistant/skills/Fabric/PatternCatalog.md` | Full pattern documentation |
| `~/.config/assistant/skills/Fabric/Workflows/` | Execution workflows |
| `~/.config/assistant/skills/Fabric/Tools/` | CLI utilities |
