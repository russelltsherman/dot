...
**Location:** `~/.config/assistant/skills/CORE/Tools/fabric/Patterns/`
...
```bash
~/.config/assistant/skills/CORE/Tools/fabric/update-patterns.sh
```
...
All templates live in `~/.config/assistant/skills/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun ~/.config/assistant/skills/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '~/.config/assistant/skills/Prompting/Tools/RenderTemplate.ts';
