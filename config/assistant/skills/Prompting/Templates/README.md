...
```bash
bun run ~/.config/assistant/skills/Prompting/Tools/RenderTemplate.ts \
...
```bash
bun run ~/.config/assistant/skills/Prompting/Tools/ValidateTemplate.ts \
...
- `~/.config/assistant/skills/CORE/Prompting.md` (Templating section)
- `~/.config/assistant/History/research/2025-12/2025-12-09-templating-system-research.md`
- `~/.config/assistant/History/learnings/2025-12/2025-12-09-021700_LEARNING_complete-templating-system-and-evals-integration.md`
- `~/.config/assistant/skills/Evals/SKILL.md`
