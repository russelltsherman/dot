...
**Invoke:** Read ~/.config/assistant/skills/PrivateInvestigator/Workflows/Reverse-lookup.md
...
**Invoke:** Read ~/.config/assistant/skills/PrivateInvestigator/Workflows/Verify-identity.md
