...
```bash
mkdir -p ~/.config/assistant/skills/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `~/.config/assistant/skills/Evals/UseCases/<name>/config.yaml`:
...
Create `~/.config/assistant/skills/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `~/.config/assistant/skills/Evals/UseCases/<name>/test-cases/`:
...
Create `~/.config/assistant/skills/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run ~/.config/assistant/skills/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la ~/.config/assistant/skills/Evals/UseCases/<name>/

# Validate config
bun run ~/.config/assistant/skills/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run ~/.config/assistant/skills/Evals/EvalServer/cli-run.ts \
  --use-case <name> \
  --test-id 001-basic \
  --verbose
```
