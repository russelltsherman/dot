...
```bash
# Check prompts exist
ls ~/.config/assistant/skills/Evals/UseCases/<name>/prompts/
...
Create `~/.config/assistant/skills/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run ~/.config/assistant/Templates/Tools/RenderTemplate.ts \
  ...
  -d ~/.config/assistant/skills/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o ~/.config/assistant/skills/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
