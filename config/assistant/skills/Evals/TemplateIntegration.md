...
```
~/.config/assistant/Templates/Evals/
...
bun run ~/.config/assistant/Templates/Tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d ~/.config/assistant/skills/Evals/UseCases/<name>/judge-config.yaml \
  -o ~/.config/assistant/skills/Evals/UseCases/<name>/judge-prompt.md
```
...
bun run ~/.config/assistant/Templates/Tools/RenderTemplate.ts \
  -t Evals/Rubric.hbs \
  -d ~/.config/assistant/skills/Evals/UseCases/<name>/rubric.yaml \
  -o ~/.config/assistant/skills/Evals/UseCases/<name>/rubric.md
```
