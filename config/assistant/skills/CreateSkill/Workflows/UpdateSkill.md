...
```
~/.config/assistant/skills/CORE/SkillSystem.md
```
...
```bash
~/.config/assistant/skills/[SkillName]/SKILL.md
```
...
```bash
touch ~/.config/assistant/skills/[SkillName]/Tools/ToolName.ts
touch ~/.config/assistant/skills/[SkillName]/Tools/ToolName.help.md
```
