...
1. Read the skill system documentation: `~/.config/assistant/skills/CORE/SkillSystem.md`
2. Read the canonical example: `~/.config/assistant/skills/_BLOGGING/SKILL.md`
...
```bash
mkdir -p ~/.config/assistant/skills/[SkillName]/Workflows
mkdir -p ~/.config/assistant/skills/[SkillName]/Tools
```

**Example:**
```bash
mkdir -p ~/.config/assistant/skills/Daemon/Workflows
mkdir -p ~/.config/assistant/skills/Daemon/Tools
```
...
```bash
touch ~/.config/assistant/skills/[SkillName]/Workflows/[WorkflowName].md
```
...
**Reference:** `~/.config/assistant/skills/CORE/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch ~/.config/assistant/skills/Daemon/Workflows/UpdateDaemonInfo.md
touch ~/.config/assistant/skills/Daemon/Workflows/UpdatePublicRepo.md
touch ~/.config/assistant/skills/_BLOGGING/Workflows/Create.md
touch ~/.config/assistant/skills/_BLOGGING/Workflows/Publish.md
```
...
Run this check:
```bash
ls ~/.config/assistant/skills/[SkillName]/
ls ~/.config/assistant/skills/[SkillName]/Workflows/
ls ~/.config/assistant/skills/[SkillName]/Tools/
```
