...
### Skill Directory
```bash
ls ~/.config/assistant/skills/ | grep -i [skillname]
```
...
```bash
ls -la ~/.config/assistant/skills/[SkillName]/
```
...
```bash
bun ~/.config/assistant/skills/[SkillName]/Tools/[ToolName].ts --help
```
...
```bash
grep -l "Intent-to-Flag" ~/.config/assistant/skills/[SkillName]/Workflows/*.md
```
...
**Reference:** `~/.config/assistant/skills/CORE/CliFirstArchitecture.md`
