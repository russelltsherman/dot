...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `~/.config/assistant/skills/CORE/SkillSystem.md`

**Canonical example to follow:** `~/.config/assistant/skills/_BLOGGING/SKILL.md`
...
**See:** `~/.config/assistant/skills/CORE/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `~/.config/assistant/skills/CORE/SkillSystem.md` (Dynamic Loading Pattern section)
