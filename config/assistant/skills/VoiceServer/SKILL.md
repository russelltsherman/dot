...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/VoiceServer/`
...
**Algorithm**: `~/.config/assistant/skills/CORE/SYSTEM/THEALGORITHM.md`
...
- **Manage**: `~/.config/assistant/VoiceServer/{start,stop,status,restart}.sh`
...
Configure voice IDs in your environment or `~/.config/assistant/VoiceServer/voices.json`

**Prosody Quick Reference**:
- Emotional: `[💥 excited]` `[✨ success]` `[⚠️ caution]` `[🚨 urgent]`
- Emphasis: `**bold**` for key words, `...` for pause, `--` for break

**Infrastructure**: Server at `~/.config/assistant/VoiceServer/`, Port 8888, Config `voices.json`
