...
cp -r ~/.config/assistant/skills/_TELOS/report-template/* {output_dir}/
...
```
~/.config/assistant/skills/_TELOS/report-template/
```
...
cp ~/Projects/ULSite/public/fonts/*.woff2 ~/.config/assistant/skills/_TELOS/report-template/public/fonts/
```

**To update template components:**
Edit files in `~/.config/assistant/skills/_TELOS/report-template/components/`

**To change color scheme:**
Edit CSS custom properties in `~/.config/assistant/skills/_TELOS/report-template/app/globals.css`
