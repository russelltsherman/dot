...
```bash
cp -r ~/.config/assistant/skills/telos/dashboard-template /path/to/your/project
...
- Searches `~/.config/assistant/skills/life/telos/` for `.md` files
- Searches `~/.config/assistant/skills/life/telos/data/` for `.csv` files
