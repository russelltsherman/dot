...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `~/.config/assistant/skills/CORE/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `~/.config/assistant/skills/CORE/USER/TELOS/` |
...
```
~/.config/assistant/skills/CORE/USER/TELOS/
```
...
All files located in `~/.config/assistant/skills/CORE/USER/TELOS/`:
...
```bash
# View specific file
read ~/.config/assistant/skills/CORE/USER/TELOS/GOALS.md
read ~/.config/assistant/skills/CORE/USER/TELOS/BELIEFS.md

# View recent updates
read ~/.config/assistant/skills/CORE/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `~/.config/assistant/skills/CORE/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `~/.config/assistant/skills/CORE/USER/TELOS/` (in the CORE USER directory)
