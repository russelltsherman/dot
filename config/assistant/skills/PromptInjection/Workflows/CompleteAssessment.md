...
`~/.config/assistant/skills/PromptInjection/Workflows/Reconnaissance.md`
...
**Save to:**
```
~/.config/assistant/History/research/YYYY-MM-DD_[client]-recon/
...
`~/.config/assistant/skills/PromptInjection/Workflows/DirectInjectionTesting.md`
...
```
~/.config/assistant/History/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
`~/.config/assistant/skills/PromptInjection/Workflows/IndirectInjectionTesting.md`
...
**Document findings in:**
```
~/.config/assistant/History/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
`~/.config/assistant/skills/PromptInjection/Workflows/MultiStageAttacks.md`
...
```
~/.config/assistant/History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
~/.config/assistant/History/research/YYYY-MM-DD_[client]-defenses/
...
`~/.config/assistant/skills/PromptInjection/Reporting.md`
...
**Deliverables:**
```
~/.config/assistant/History/research/YYYY-MM-DD_[client]-final-report/
