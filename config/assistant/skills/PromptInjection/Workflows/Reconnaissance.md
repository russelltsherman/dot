...
`~/.config/assistant/skills/PromptInjection/APPLICATION-RECONNAISSANCE-METHODOLOGY.md`

**Attack taxonomy for prioritization:**
`~/.config/assistant/skills/PromptInjection/COMPREHENSIVE-ATTACK-TAXONOMY.md`
