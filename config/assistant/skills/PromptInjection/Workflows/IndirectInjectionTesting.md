...
`~/.config/assistant/skills/PromptInjection/COMPREHENSIVE-ATTACK-TAXONOMY.md` (Section 2)

**RAG security best practices:**
`~/.config/assistant/skills/PromptInjection/DEFENSE-MECHANISMS.md` (RAG Defense)
