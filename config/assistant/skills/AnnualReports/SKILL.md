...
`~/.config/assistant/skills/CORE/USER/SKILLCUSTOMIZATIONS/AnnualReports/`
...
bun run ~/.config/assistant/skills/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run ~/.config/assistant/skills/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run ~/.config/assistant/skills/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
